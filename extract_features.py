...
Fs = 8900 # frecuencia muestreo
N = 1000 # numero de datos
t = np.linspace(0,N/Fs,N) # time vector
y = 1.5*np.sin(2550.0 * 2.0*np.pi*t) + 4*np.sin((3600.0)* 2.0*np.pi*t)+ 2*np.cos(2020.0 * 2.0*np.pi*t)+ 3*np.cos(4000.0 * 2.0*np.pi*t)+3*np.cos(1000.0 * 2.0*np.pi*t)
