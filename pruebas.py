...
class View(QtCore.QObject):  # hereda de la clase QtGui.QmainWindow
    ...
    def saveObjectHandler (self, object_to_save):
        ...
        if object_to_save == "1":
            print ("object 1 saved as: "+str(self.window.object1Name))
    ...
    def identify_fuction(self):
        ...
        self.window.object1_result.display(10)
        self.window.object2_result.display(15)
        self.window.object3_result.display(96)
